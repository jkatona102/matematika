...
:::{.korolar}
Neka su $\lim_{n \to \infty} a_n = a$ i $\lim_{n \to \infty} b_n = b$. Tada je za sve $\lambda, \mu \in \mathbb{R}$ niz $(\lambda a_n + \mu b_n)_n$ konvergent i vrijedi $\lim_{n \to \infty} (\lambda a_n + \mu b_n) = \lambda a + \mu b$.
:::
...
4. Funkcija $|f|$ ima limes u $c$ i $\displaystyle \lim_{x \to c} |f(x)| = |\lim_{x \to c} f(x)|$
:::
