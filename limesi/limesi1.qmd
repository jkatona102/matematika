...
3. Ako je $\forall n \in \mathbb{N}, b_n \neq 0$ i $\displaystyle \lim_{n \to \infty} b_n \neq 0$, onda je niz $\displaystyle \left (\frac{a_n}{b_n} \right)_n$ konvergentan i vrijedi $\displaystyle \lim_{n \to \infty} \left (\frac{a_n}{b_n} \right)_n = \displaystyle \frac{\lim_{n \to \infty} a_n}{\lim_{n \to \infty} b_n}$ 
4. Niz $(|a_n|)_n$ je konvergentan i $\lim_{n \to \infty} |a_n| = |\displaystyle \lim_{n \to \infty} a_n|$
:::
