...
# Točka u kojoj promatramo neprekidnost
x0 = 1
delta = 0.4
epsilon = 1.0
...
# ε-okolina oko f(x0)
plt.axhline(y0 + epsilon, linestyle="--")
plt.axhline(y0 - epsilon, linestyle="--")

# δ-okolina oko x0
plt.axvline(x0 + delta, linestyle="--")
plt.axvline(x0 - delta, linestyle="--")

# Obojano područje ε-okoline
plt.fill_between(
    x,
    y0 - epsilon,
    y0 + epsilon,
...
plt.xlabel("$x$")
plt.ylabel("$f(x)$")
plt.title("Skica neprekidnosti u točki $x_0$")
plt.grid(True)
